  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        toast.error(isPt ? 'Erro ao fazer login.' : 'Error logging in.')
      }
    } catch {
      toast.error(isPt ? 'Erro ao fazer login.' : 'Error logging in.')
    } finally {
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-white/50 text-lg mb-10">
            {isPt ? 'Acompanhe os seus projetos e gerencie os seus servicos.' : 'Track your projects and manage your services.'}
          </p>
        ...
        <p className="relative text-white/20 text-xs">
          &copy; {new Date().getFullYear()} Tec Fazer.
        </p>
      </div>
